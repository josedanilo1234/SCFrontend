      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-header" v-if="editar==='false'">
            <h3 class="mx-auto">Consultar Moto</h3>
          </div>
          <div class="card-body">
                      ...
                      <td>
                        <div class="table-actions">
                          <div class="col-md-12 text-center" style="margin-left: -26%;">
                            <b-button
                              @click="ConsultarMotoID(item.PLACA)"
                              class="btn-info ik ik-edit-2"
                            ></b-button>
                            <b-button
                              @click="EliminarMotoID(item.PLACA)"
                              style="margin-left:2%;"
...
export default {
  data() {
    return {
      rutaC: "http://localhost:3000/api/cliente/", //Ruta de la API a la cuan se envian las
  ...
  methods: {
    ...
    ConsultarMoto() {
      if (this.parametro === "") {
        ...
        fetch(this.rutaM + `/${this.parametro}`, {
          method: "GET",
          mode: "cors",
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
    ...
    ConsultarMotoID(cedula) {
      this.editar = "true";
      fetch(this.rutaM + `/${cedula}`, {
        method: "GET",
        mode: "cors",
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token"),
    ...
    ActualizarMoto() {
      ...
      fetch(this.rutaM + "/" + this.datos.PLACA, {
        method: "PUT",
        mode: "cors",
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token"),
    ...
    EliminarMotoID(codigo) {
      fetch(this.rutaM + "/" + codigo, {
        method: "DELETE",
        mode: "cors",
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token"),
