      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-header" v-if="editar==='true'">
            <h3 class="mx-auto">Actualizar Servicio</h3>
          </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input
                        ...
                        class="form-control"
                        placeholder="Fecha"
                        v-model="servicioID.FECHA_PROCEDIMIENTO"
                      />
                    </div>
                  </div>
                </div>
          ...
          <div class="card-header" v-if="editar==='false'">
            <h3 class="mx-auto">Consultar Servicio</h3>
          </div>
            ...
            <div v-if="consulta==='true'">
              <div class="col-md-8 mx-auto">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(item, index) in Servicio" :key="index">
                      ...
                      <td>
                        <div class="table-actions">
                          <div class="col-md-12 text-center" style="margin-left: -26%;">
                            <b-button
                              @click="ConsultarServicioID(item.CODIGO)"
                              class="btn-info ik ik-edit-2"
                            ></b-button>
                            <b-button
                              @click="EliminarServicioID(item.CODIGO)"
                              style="margin-left:2%;"
...
export default {
  data() {
    return {
      rutaC: "http://localhost:3000/api/servicio/", //Ruta de la API a la cuan se envian las peticiones
      Servicio: [], //Arreglo para obtener clientes de la
      consulta: "false",
      editar: "false",
      parametro: "",
  ...
  methods: {
        ...
        .then(data => {
          if (data.Error) {
            ...
            this.tokenInvalido();
             ...
             var fecha=data[0].FECHA_PROCEDIMIENTO;
             fecha=fecha.split('T')[0]
             var año=fecha.split('-')[0]
             var mes=fecha.split('-')[1]
             var dia=fecha.split('-')[2]
             fecha=año+"-"+mes+"-"+dia
            data[0].FECHA_PROCEDIMIENTO=fecha
            
            this.servicioID = data[0];
            //fecha();
          }
        })
        .catch(e => {
    ...
    ActualizarServicio() {
      ...
      fetch(this.rutaC + "/" + this.servicioID.CODIGO, {
        method: "PUT",
        mode: "cors",
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token"),
        ...
        body: JSON.stringify(this.servicioID)
      })
        .then(res => res.json())
        .then(data => {
          if (data.Error) {
  ...
  fecha(){
     //fecha= new String(this.servicioID.FECHA_PROCEDIMIENTO)
     //var nueva=fecha.split("t");
     //console.log(fecha)
  }
};
</script>